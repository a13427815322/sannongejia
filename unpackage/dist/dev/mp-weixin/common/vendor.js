...
const pages = [
  ...
  {
    path: "pages/dingdandetail/dingdandetail",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/pingjiadetail/pingjiadetail",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
...
const tabBar = {
  list: [
    {
      iconPath: "static/Vectored.png",
      pagePath: "pages/index/index",
      selectedIconPath: "static/Vector.png",
      text: "首页"
    },
    {
      iconPath: "static/Community.png",
      pagePath: "pages/community/community",
      selectedIconPath: "static/Communityfill.png",
      text: "互助社区"
    },
    {
      iconPath: "static/shop.png",
      pagePath: "pages/shop/shop",
      selectedIconPath: "static/Shoped.png",
      text: "农资商城"
    },
    {
      iconPath: "static/ShoppingTrolley.png",
      pagePath: "pages/shoppingcart/shoppingcart",
      selectedIconPath: "static/ShoppingTrolleyfill.png",
      text: "购物车"
    },
    {
      iconPath: "static/Personal.png",
      pagePath: "pages/me/me",
      selectedIconPath: "static/Personalfill.png",
      text: "个人中心"
    }
  ]
};
...
const y = true, _ = "mp-weixin", v = m([]), S = _, k = m('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "169.254.207.164",\n        "169.254.166.39",\n        "172.17.24.174"\n    ],\n    "debugPort": 9003,\n    "initialLaunchType": "local",\n    "servePort": 7002,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/web前端开发/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"cloud1","spaceId":"mp-efbf9779-c0d9-4262-ab16-a6d0746727bb","clientSecret":"w/EoTyZVBk+G5eYAfUswug==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__87AB87D";
} catch (e2) {
...
const Qn = !!pagesJson.uniIdRouter;
const { loginPage: Xn, routerNeedLogin: Zn, resToLogin: es, needLoginPage: ts, notNeedLoginPage: ns, loginPageInTabBar: ss } = function({ pages: e2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = pagesJson) {
