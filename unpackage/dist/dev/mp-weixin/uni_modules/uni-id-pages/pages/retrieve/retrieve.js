...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.sr("shortCode", "1d85d3e4-4,1d85d3e4-3"),
    ...
    v: common_vendor.sr("form", "1d85d3e4-0"),
    w: common_vendor.p({
      value: $data.formData,
      ["err-show-type"]: "toast"
    }),
    x: common_vendor.sr("popup", "1d85d3e4-9"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "Y:/mui原型/三农e家/uni_modules/uni-id-pages/pages/retrieve/retrieve.vue"]]);
