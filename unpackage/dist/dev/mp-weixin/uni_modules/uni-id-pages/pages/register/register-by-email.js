...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("shortCode", "5a8d3f3f-10,5a8d3f3f-9"),
    ...
    y: common_vendor.sr("agreements", "5a8d3f3f-11,5a8d3f3f-0"),
    z: common_vendor.p({
      scope: "register"
    }),
    ...
    E: common_vendor.sr("form", "5a8d3f3f-0"),
    F: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "Y:/mui原型/三农e家/uni_modules/uni-id-pages/pages/register/register-by-email.vue"]]);
