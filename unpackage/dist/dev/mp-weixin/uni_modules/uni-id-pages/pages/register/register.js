...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("captcha", "0f7927c4-10,0f7927c4-9"),
    v: common_vendor.o(($event) => $data.formData.captcha = $event),
    w: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    x: common_vendor.sr("agreements", "0f7927c4-11,0f7927c4-0"),
    y: common_vendor.p({
      scope: "register"
    }),
    ...
    D: common_vendor.sr("form", "0f7927c4-0"),
    E: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "Y:/mui原型/三农e家/uni_modules/uni-id-pages/pages/register/register.vue"]]);
